...
### 3.1.2 研究内容
  ...
  - ### 离岸曲流的两种形成机制
    ...
    （1）本研究首次证实外来气旋能够降低 AC 局地水平位涡梯度，使气旋得以穿越西边界流，进而引发 AC 产生脉冲状蜿蜒曲流；
    （2）反气旋与 AC 相互作用所引发的正压不稳定现象，同样会促进曲流的生成。
  - ### 能量反馈的正负循环体系
    基于能量各向异性框架下的涡动能方程，本研究揭示了正压不稳定过程中的两个核心反馈机制：
    （1）反气旋的挤压与气旋曲流的发展会强化涡各向异性，加速正压不稳定进程并推动正向能量串级，形成促进曲流发展的正反馈循环；
    （2）不同于以往研究的假设，反气旋诱导的 AC 加速及气旋曲流的发展会削弱平均流的应变率，从而抑制正向能量串级与曲流发展，构成负反馈循环。
...
### 3.2.1 研究背景与核心目标
前人对于孤立涡的演化、以及涡旋和西边界流相互作用的数值模拟大多针对正圆形的反气旋涡和经向（南北向）的西边界流。然而近期的观测表明海洋中的涡旋大多并非是正圆形的，而是**椭圆形**（甚至鸡蛋形）；西边界流也**并非是经向**的（如：东北-西南向的厄加勒斯流）。
另外，我们之前的研究表明涡旋与西边界流相互作用时会拉伸、旋转成椭圆结构，与西边界流成一定的角度。在能量各项异性的角度下，**西边界流的应变张量与涡旋的动量张量的夹角会影响能量串级的方向和强度**。
所以，不同扁度的孤立涡旋的演化过程有何区别？不同扁度、不同大小、不同强度的涡旋与不同强度、不同角度的西边界流相互作用过程有何区别？能量串级的机制有何区别？这些问题都亟待解决。
...
### 3.2.3 研究方法的创新与价值
- 拓展了涡-流相互作用研究工作，弥补了椭圆涡旋与非经向西边界流相互作用领域的研究空白。
- 推导了沿流-跨流坐标系下的跨尺度能量转换框架，具有更实际的使用效益和普适性。
...
## 5.1 学生工作
- 党性思想引领  <br>
  2020-2023年任职**物理海洋第一研究生党支部纪检委员**，监督党内纪律执行：制定推优人选量化指标，规避简单以票取人；推行每日 “学习强国” 督促计划，强化党员理论学习。同时，积极组织党支部活动：包括三校海洋科学党支部共建活动（就业先锋分享会），与公卫学院联合开展防艾同伴教育及 “嘉庚号” 参观活动，还有支部趣味羽毛球比赛，促进党员交流与凝聚力提升。
- 组织能力锻造  <br>
...
- **“景润青年”云南暑期实践队**（图6）：在云南晋宁双河民族中学开展**扶贫支教**活动。实践队六进云南以来，双河民族中学的升学率从46%增长到78%，位居全区中学第二名。
  ...
  - 对学生升学意愿进行调研并数学建模，发现学生面对困难的态度与榜样建立对升学意愿影响较大，为后续实践提供方向。
